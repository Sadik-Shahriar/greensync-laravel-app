              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{user?.eco_points || 0}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground text-sm">Bottles Recycled:</span>
                    <span className="font-medium">{user?.total_bottles_recycled || 0}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
